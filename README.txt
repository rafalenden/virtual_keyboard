Installation
------------------
1. Unpack and move directory "screen_keyboard" to your modules directory.
...
5. Enable "screen_keyboard" module in the modules list of your site.
6. Go to configuraction page at "admin/config/user-interface/screen-keyboard".
7. Specify CSS selectors for text fields you want to add a screen keyboard.
